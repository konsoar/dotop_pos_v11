...
"""
The PostgreSQL connector is a connectivity layer between the dotop code and
...
class Cursor(object):
    """Represents an open transaction to the PostgreSQL DB backend,
       ...
       ``cursor`` objects.
        ...
        such as dotop, we need the best guarantees that no data
        ...
        dotop implements its own level of locking protection
        ...
        the default transaction isolation level for dotop cursors, as
...
def close_db(db_name):
    """ You might want to call dotop.modules.registry.Registry.delete(db_name) along this function."""
    global _Pool
    if _Pool:
