...
from dotop.modules.module import get_module_root, MANIFEST_NAMES
from dotop.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the dotop server for your project"""
