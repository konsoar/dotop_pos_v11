...
from dotop.tools import frozendict, classproperty
...
def constrains(*args):
    ...
    Should raise :class:`~dotop.exceptions.ValidationError` if the
    validation failed.
...
def one(method):
    """ Decorate a record-style method where ``self`` is expected to be a
        ...
        .. deprecated:: 9.0
            ...
            is a single record with :meth:`~dotop.models.Model.ensure_one`.
    """
...
class Environment(Mapping):
    ...
    def check_cache(self):
        ...
        from dotop.fields import SpecialValue
...
from dotop.exceptions import UserError, AccessError, MissingError
