...
For now, configuration code is in dotop.tools.config. It is in mainly
...
To initialize properly this module, dotop.tools.config.parse_config()
must be used.
...
# Paths to search for dotop addons.
addons_paths = []
...
# installed (i.e. the majority of dotop addons). This is set with the --load
# command-line option.
server_wide_modules = []
