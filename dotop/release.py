...
product_name = 'dotop'
description = 'dotop Server'
long_desc = '''dotop is a complete ERP and CRM. The main features are accounting (analytic
...
"""
url = 'https://www.dotop.com'
author = 'dotop S.A.'
author_email = 'info@dotop.com'
license = 'LGPL-3'

nt_service_name = "dotop-server-" + series
