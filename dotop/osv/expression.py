...
term representation was ['=', 'company_id.name', 'dotop']. Used in a
...
dotop will use the SQL function 'unaccent' when available for the
...
Finally, to instruct dotop to really use the unaccent function, you have to
...
def get_unaccent_wrapper(cr):
    if dotop.registry(cr.dbname).has_unaccent:
