...
class TestExpression(TransactionCase):
    ...
    def test_15_m2o(self):
        ...
        # that don't have dotop has a parent company, you expect to find,
    ...
    def test_active(self):
        ...
        vals = {
            ...
            'child_ids': [(0, 0, {'name': 'address of dotop Test', 'country_id': self.ref("base.be")})],
        }
        Partner.create(vals)
