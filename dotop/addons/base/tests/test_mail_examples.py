...
cite="mid:CAEJSRZvWvud8c6Qp=wfNG6O1+wK3i_jb33qVrF7XyrgPNjnyUA@mail.gmail.com"
      type="cite"><base href="https://www.dotop.com">
      <div dir="ltr">Yep Dominique that is true, as Postgres was the
        base of all same as dotop and MySQL etc came much later.Â 
        <div><br>
        </div>
    ...
    on this dotop mailinglist, but when you start implying that Postgres
...
HOTMAIL_1 = """<div>
    <div dir="ltr"><br>
        I have an amazing company, i'm learning dotop, it is a small company yet, but plannig to grow up quickly.
        <br><br>Kindest regards,<br>xxx<br>
        <div>
            <div id="SkyDrivePlaceholder">
            </div>
            <hr id="stopSpelling">
            Subject: Re: your dotop.com registration<br>From: xxx@xxx.xxx<br>To: xxx@xxx.xxx<br>Date: Wed, 27 Mar 2013 17:12:12 +0000
            <br><br>
            Hello xxx,
            <br>
            I noticed you recently created an dotop.com account to access dotop Apps.
            <br>
            You indicated that you wish to use dotop in your own company.
            ...
            Best regards,<br>
            <pre>
                <a href="http://dotop.com" target="_blank">http://dotop.com</a>
...
HOTMAIL_1_OUT = [
    ...
    """<pre data-o-mail-quote="1">
                <a href="http://dotop.com" target="_blank" data-o-mail-quote="1">http://dotop.com</a>
                Belgium: +32.81.81.37.00
                U.S.: +1 (650) 307-6736
                India: +91 (79) 40 500 100
            </pre>"""]
...
<div class="WordSection1">
        ...
        <p class="MsoNormal">
            <span style="font-size:11.0pt;font-family:&quot;Calibri&quot;,&quot;sans-serif&quot;;color:#1F497D">
                ...
                If we adopt dotop we will probably move to Linux or look for a hosted SaaS option.
            </span>
        </p>
        <p></p>
        <p></p>
            ...
            <div style="border:none;border-top:solid #B5C4DF 1.0pt;padding:3.0pt 0in 0in 0in">
                <p class="MsoNormal">
                    ...
                    <span style="font-size:10.0pt;font-family:&quot;Tahoma&quot;,&quot;sans-serif&quot;">
                        dotop Enterprise [mailto:sales@dotop.com]
                        <br><b>Sent:</b> Monday, 11 March, 2013 14:47<br><b>To:</b> Alan Widmer<br><b>Subject:</b> Re: your dotop.com registration
                    </span>
                </p>
                <p></p>
                <p></p>
        ...
        <p></p>
        <p>I noticed you recently downloaded dotop. </p>
        <p></p>
        <p>
            Uou mentioned you wish to use dotop in your own company. Please let me more about your
            business needs and requirements? When will you be available to discuss about your project?
        </p>
        <p></p>
        <p>Thanks for your interest in dotop, </p>
        <p></p>
        ...
        <pre>--<p></p></pre>
        <pre>Nicolas<p></p></pre>
        <pre><a href="http://dotop.com">http://dotop.com</a><p></p></pre>
...
MSOFFICE_1_OUT = ['I noticed you recently downloaded dotop.', 'Uou mentioned you wish to use dotop in your own company.', 'Belgium: +32.81.81.37.00']
...
B-1367 Gérompont
Tel: +32.81.81.37.00
Web: http://www.dotop.com"""]


REMOVE_CLASS = """
<div style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'; COLOR: #000000">
    <div>Hello</div>
    <div>I have just installed dotop 9 and I've got the following error:</div>
    <div>&nbsp;</div>
    <div class="dotop dotop_webclient_container oe_webclient">
    ...
    <div role="dialog" tabindex="-1" aria-hidden="false" class="modal in" style="DISPLAY: block" data-backdrop="static">
        <div class="modal-dialog modal-lg">
            <div class="modal-content dotop">
                <div class="modal-header"> 
                    <h4 class="modal-title">dotop Error<span class="o_subtitle text-muted"></span></h4>
                </div>
