...
from dotop.tools import mute_logger
import dotop.tests.common as common
import dotop.workflow
...
class TestServerActions(TestServerActionsBase):
    ...
    def test_20_trigger(self):
        ...
        # Clear workflow cache, otherwise dotop will try to create workflows even if it has been deleted
        dotop.workflow.clear_cache(self.cr, self.uid)
    ...
    @mute_logger('dotop.addons.base.ir.ir_model', 'dotop.models')
