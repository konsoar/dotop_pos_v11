...
<header>
    <pageTemplate>
        ...
        <pageGraphics>
            ...
            <rotate degrees="90"/>
            <fill color="grey"/>
            <drawString x="2.65cm" y="-0.4cm">generated by dotop.com</drawString>
            <fill color="black"/>
            <rotate degrees="-90"/>
    ...
    name = fields.Char(related='partner_id.name', string='Company Name', required=True, store=True, show_report=True)
    ...
    rml_header1 = fields.Char(string='Company Tagline', help="Appears by default on the top right corner of your printed documents (report header).", show_report=True)
    ...
    street = fields.Char(compute='_compute_address', inverse='_inverse_street', show_report=True)
    ...
    email = fields.Char(related='partner_id.email', store=True, show_report=True)
    phone = fields.Char(related='partner_id.phone', store=True, show_report=True)
    fax = fields.Char(compute='_compute_address', inverse='_inverse_fax', show_report=True)
    website = fields.Char(related='partner_id.website', show_report=True)
