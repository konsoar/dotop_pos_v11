...
from dotop import api, fields, models, tools, _
...
class Currency(models.Model):
    ...
    def _compute_current_rate(self):
        ...
        currency_rates = self._compute_rate(date, company_id)
        for currency in self:
            currency.rate = currency_rates.get(currency.id) or 1.0
    
    @api.multi
    def _compute_rate(self, date, company_id):
    ...
    def round(self, amount):
        ...
        # https://github.com/dotop/dotop/commit/36ee1ad813204dcb91e9f5f20d746dff6f080ac2
        # https://github.com/dotop/dotop/commit/0b6058c585d7d9a57bd7581b8211f20fca3ec3f7
    ...
    def get_format_currencies_js_function(self):
        ...
        for currency in self.search([]):
            ...
            format_number_str = "dotop.web.format_value(arguments[0], {type: 'float', digits: [69,%s]}, 0.00)" % currency.decimal_places
