...
from dotop import api, models, tools
from dotop.tools.safe_eval import assert_valid_codeobj, _BUILTINS, _SAFE_OPCODES
from dotop.http import request
from dotop.modules.module import get_resource_path
import json
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _get_asset_content(self, xmlid, options):
        ...
        def get_modules_order():
            if request:
                from dotop.addons.web.controllers.main import module_boot
