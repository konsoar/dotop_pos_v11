...
BASE_VERSION = dotop.modules.load_information_from_description_file('base')['version']
        ...
        try:
            ...
            if model_name in self.env:
                ...
                if hasattr(model, method_name):
                    ...
                    dotop.netsvc.log(_logger, logging.DEBUG, 'cron.object.execute', (self._cr.dbname, self._uid, '*', model_name, method_name)+tuple(args), depth=log_depth)
                    start_time = False
    ...
    def _acquire_job(cls, db_name):
        ...
        try:
            ...
            if e.pgcode == '42P01':
                ...
                # The table ir_cron does not exist; this is probably not an dotop database.
        ...
        for job in jobs:
            ...
            try:
                ...
                job_cr = db.cursor()
                try:
                    registry = dotop.registry(db_name)
