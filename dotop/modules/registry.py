...
from dotop.tools import (assertion_report, lazy_classproperty, config,
                        lazy_property, topological_sort, OrderedSet)
from dotop.tools.lru import LRU
...
class Registry(Mapping):
    ...
    def __new__(cls, db_name):
        ...
        with cls._lock:
            try:
                ...
                # dotop.service.wsgi_server.application
        ...
        with cls._lock:
            with dotop.api.Environment.manage():
                ...
                try:
                    ...
                    dotop.modules.load_modules(registry._db, force_demo, status, update_module)
                except Exception:
    ...
    def init(self, db_name):
        ...
        self._db = dotop.sql_db.db_connect(db_name)
        ...
        # Inter-process signaling (used only when dotop.multi_process is True):
        ...
        with closing(self.cursor()) as cr:
            has_unaccent = dotop.modules.db.has_unaccent(cr)
            if dotop.tools.config['unaccent'] and not has_unaccent:
                _logger.warning("The option --unaccent was given but no unaccent() function was found in database.")
            self.has_unaccent = dotop.tools.config['unaccent'] and has_unaccent
    ...
    def init_models(self, cr, model_names, context):
        ...
        env = dotop.api.Environment(cr, SUPERUSER_ID, context)
    ...
    def signal_caches_change(self):
        ...
        if dotop.multi_process and self.cache_cleared:
