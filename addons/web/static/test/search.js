dotop.define_section('search.query', ['web.SearchView'], function (test) {
...
dotop.define_section('search.defaults', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data', 'web.data_manager'], function (test, mock) {
...
dotop.define_section('search.completions', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data', 'web.data_manager'], function (test, mock) {
    ...
    test('facet selection', function (assert) {
        ...
        var completion = {
            ...
            facet: {
                field: {
                    get_domain: dotop.testing.noop,
                    get_context: dotop.testing.noop,
                    get_groupby: dotop.testing.noop
                },
                category: 'Dummy',
                values: [{label: 'dummy', value: 42}]
            }
...
dotop.define_section('search.serialization', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data', 'web.data_manager'], function (test, mock) {
...
dotop.define_section('search.filters', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data', 'web.data_manager'], function (test, mock) {
...
dotop.define_section('search.groupby', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data', 'web.data_manager'], function (test, mock) {
...
dotop.define_section('search.filters.saved', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data', 'web.data_manager'], function (test, mock) {
...
dotop.define_section('search.advanced', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data', 'web.data_manager'], function (test, mock) {
