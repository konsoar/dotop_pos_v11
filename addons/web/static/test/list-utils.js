dotop.define_section('list.events', ['web.list_common'], function (test) {
...
dotop.define_section('list.records', ['web.list_common'], function (test) {
...
dotop.define_section('list.Collection', ['web.list_common'], function (test) {
...
dotop.define_section('list.collections.higherordermethods', ['web.list_common'], function (test) {
...
dotop.define_section('list.collections.weirdoes', ['web.list_common'], function (test) {
