dotop.define_section('eval.basics', ['web.pyeval'], function(test, mock) {
...
dotop.define_section('eval.types', ['web.pyeval'], function (test, mock) {
...
dotop.define_section('eval.edc', ['web.pyeval', 'web.session'], function (test, mock) {
...
dotop.define_section('eval.edc.nonliterals', ['web.pyeval', 'web.session'], function (test, mock) {
    function setup(session) {
...
dotop.define_section('eval.contexts', ['web.pyeval'], function (test) {
...
dotop.define_section('eval.domains', ['web.pyeval'], function (test) {
...
dotop.define_section('eval.groupbys', ['web.pyeval'], function (test) {
