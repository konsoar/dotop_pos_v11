dotop.define_section('editor', ['web.ListEditor'], function (test, mock) {
...
dotop.define_section('list.edition', ['web.data', 'web.ListView', 'web.data_manager'], function (test, mock) {
...
dotop.define_section('list.edition.events', ['web.data', 'web.ListView', 'web.data_manager'], function (test, mock) {
...
dotop.define_section('list.edition.onwrite', ['web.data', 'web.ListView', 'web.data_manager'], function (test, mock) {
