dotop.define_section('class', ['web.Class'], function (test) {
...
dotop.define_section('Widget.proxy', ['web.Widget'], function (test) {
...
dotop.define_section('Widget.renderElement', ['web.Widget'], function (test) {
...
dotop.define_section('Widget.$', ['web.Widget', 'web.core'], function (test) {
...
dotop.define_section('Widget.events', ['web.Widget', 'web.core'], function (test) {
    function setup(qweb) {
       qweb.add_template(
            '<no>' +
                '<t t-name="test.widget.template">' +
...
dotop.define_section('Widget.async', ['web.Widget', 'web.utils'], function (test) {
...
dotop.define_section('server-formats', ['web.time'], function (test) {
