dotop.define('web.ActionManager', function (require) {
"use strict";
...
var ActionManager = Widget.extend({
     ...
     *
     * widget: typically, widgets added are dotop.web.ViewManager. The action manager
    ...
    ir_actions_act_url: function (action) {
        ...
        if (session.debug && url && url.length && url[0] === '/') {
            url = $.param.querystring(url, {devil: session.debug});
        }
