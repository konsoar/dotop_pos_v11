dotop.define('web.ControlPanelMixin', function (require) {
"use strict";
...
dotop.define('web.ControlPanel', function (require) {
"use strict";
...
var ControlPanel = Widget.extend({
     ...
     * @param {dotop.web.SearchView} [status.searchview] the searchview widget
     ...
     * @param {dotop.web.SearchView} [searchview] the searchview Widget
