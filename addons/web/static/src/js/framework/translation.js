...
dotop.define('web.translation', function (require) {
"use strict";
...
var TranslationDataBase = Class.extend(/** @lends instance.TranslationDataBase# */{
    ...
    /**
        Loads the translations from an dotop server.

        @param {dotop.Session} session The session object to contact the server.
