dotop.define('web.mixins', function (require) {
"use strict";
...
function dotopEvent (target, name, data) {
    this.target = target;
    this.name = name;
...
dotopEvent.prototype.stop_propagation = function () {
    this.stopped = true;
};

dotopEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
    ...
    trigger_up: function(name, info) {
        var event = new dotopEvent(this, name, info);
