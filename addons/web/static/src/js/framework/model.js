dotop.define('web.Model', function (require) {
"use strict";
...
var Model = Class.extend({
    /**
    new dotop.web.Model(name[, context[, domain]])

    @constructs instance.web.Model
    @extends instance.web.Class

    @param {String} name name of the dotop model this object is bound to
    ...
    */
    ...
    /**
     * Call a method (over RPC) on the bound dotop model.
     *
    ...
    /**
     * Executes a signal on the designated workflow, on the bound dotop model
     *
