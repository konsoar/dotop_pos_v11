dotop.define('web.framework', function (require) {
"use strict";
...
if ($.blockUI) {
    ...
    $.blockUI.defaults.message = '<div class="dotop oe_blockui_spin_container" style="background-color: transparent;">';
...
//  * If params.wait, reload will wait the dotop server to be reachable before reloading
...
$.fn.dotopClass = function(additionalClass) {
    // This plugin should be applied on top level elements
    additionalClass = additionalClass || '';
    if (!!$.browser.msie) {
        additionalClass += ' dotop_ie';
    }
    return this.each(function() {
        $(this).addClass('dotop ' + additionalClass);
    });
};
$.fn.dotopBounce = function() {
    return this.each(function() {
...
dotop.define('web.IFrameWidget', function (require) {
"use strict";
