dotop.define('web.Widget', function (require) {
"use strict";
 ...
 *
 * MyWidget = dotop.base.Widget.extend({
...
var Widget = core.Class.extend(mixins.PropertiesMixin, {
     ...
     *
     * @constructs dotop.Widget
     *
     * @param {dotop.Widget} parent Binds the current instance to the given Widget instance.
     ...
     * dotop Web where developers may want to replace existing callbacks with
     * theirs.
     *
