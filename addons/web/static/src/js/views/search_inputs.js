dotop.define('web.search_inputs', function (require) {
"use strict";
...
/**
 * Implementation of the ``char`` dotop field type:
 *
...
/**
 * Implementation of the ``datetime`` dotop field type:
 *
...
var FilterGroup = Input.extend(/** @lends instance.web.search.FilterGroup# */{
     ...
     *
     * @param {dotop.web.search.Facet} facet
...
var Filter = Input.extend(/** @lends instance.web.search.Filter# */{
    ...
    /**
     * Implementation of the dotop filters (button with a context and/or
