dotop.define('web.form_common', function (require) {
"use strict";
 ...
 *     This event is not related to the on_change mechanism of dotop and is always called
...
var FieldManagerMixin = {
    ...
    */
    ...
    /**
    Computes an dotop domain.

    @param {Array} expression An dotop domain.
    ...
    */
    ...
    @return {CompoundContext} An dotop context.
    */
...
var FieldInterface = {
     ...
     * osv class in the dotop server as well as the syntax used by the set_value() (see below). It must
     ...
     * the dotop server, although it is not assumed to respect the constraints applied to the field.
...
var AbstractField = FormWidget.extend(FieldInterface, {
    ...
    */
     ...
     * value is similar to false in dotop.
     */
    is_false: function() {
