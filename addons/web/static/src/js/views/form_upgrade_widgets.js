dotop.define('web.form_upgrade_widgets', function (require) {
"use strict";
...
var AbstractFieldUpgrade = {
    ...
    open_dialog: function() {
        ...
        return new Dialog(this, {
            ...
            title: _t("dotop Enterprise"),
        }).open();
    },
  
    confirm_upgrade: function() {
        new Model("res.users").call("search_count", [[["share", "=", false]]]).then(function(data) {
            framework.redirect("https://www.dotop.com/dotop-enterprise/upgrade?num_users=" + data);
        });
    },
