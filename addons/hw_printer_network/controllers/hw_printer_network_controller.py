...
try:
    from dotop.addons.hw_escpos.escpos import escpos
    from dotop.addons.hw_escpos.controllers.main import EscposProxy
    from dotop.addons.hw_escpos.controllers.main import EscposDriver
    from dotop.addons.hw_escpos.escpos.exceptions import NoDeviceError, HandleDeviceError, TicketNotPrinted, NoStatusError
    from dotop.addons.hw_escpos.escpos.printer import Network
    import dotop.addons.hw_escpos.controllers.main as hw_escpos_main
except ImportError:
    EscposProxy = object
